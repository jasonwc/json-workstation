...
# Bootstrap script for JSON-PAPERBOOK (Papercompute work Mac, aarch64-darwin)
# Assumes:
#   - Xcode Command Line Tools are installed
#   - This repo is already cloned somewhere (this script lives inside it)
#
# Usage:
#   cd /path/to/json-workstation && bash hosts/paperbook/bootstrap.sh

SYSTEM_DIR="$HOME/.system"
HOSTNAME="JSON-PAPERBOOK"
...
main() {
  info "Bootstrapping $HOSTNAME (Papercompute work Mac)"
  echo
  ...
  info "Open a new shell so zsh, starship, and aliases pick up."
